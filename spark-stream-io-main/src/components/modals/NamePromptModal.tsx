          ...
          >
            ...
            >
              <div className="mb-5 flex items-center gap-2">
                ...
                <span className="text-[10px] font-semibold tracking-[0.18em] text-muted-foreground/90">
                  BIENVENIDO A KAIROS
                </span>
              </div>
              ...
              <label className="mt-6 flex flex-col gap-1.5 rounded-2xl bg-background/70 px-5 py-4 transition-colors focus-within:bg-background/90">
                <span className="text-[10px] font-semibold tracking-[0.16em] text-muted-foreground/90">
                  TU NOMBRE
                </span>
                <input
                  autoFocus
